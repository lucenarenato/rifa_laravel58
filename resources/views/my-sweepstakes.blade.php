                                            ...
                                            @else
                                                <div class="dropdown">
                                                    ...
                                                    Ações
                                                        ...
                                                        <a class="dropdown-item" href="javascript:void(0)" title="Duplicar Rifa" data-id="{{ $product->id }}" data-name="{{ $product->name }}" onclick="duplicar(this)"><i class="far fa-copy"></i>&nbsp;Duplicar Rifa</a>
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <div class="tab-content" id="myTabContent">
                                                                <div class="tab-pane fade show active"
                                                                    ...
                                                                    <div class="row mt-4">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            ...
                                                                            <input type="number" class="form-control" name="ganho_afiliado" value="{{ $product->ganho_afiliado }}">
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="tab-pane fade" id="compraAuto{{ $product->id }}"
                                                                    ...
                                                                    <div class="row mt-4">
                                                                        <input type="hidden" name="popularCheck" id="popularCheck-{{ $product->id }}" value="{{ $product->getCompraMaisPopular() }}">
                                                                        @foreach ($product->comprasAuto() as $compra)
                                                                            <div class="col-md-6 mt-2">
                                                                                <div class="input-group">
                                                                                    <div class="input-group-prepend" style="height: 37px;">
                                                                                        <span class="input-group-text">
                                                                                            <input type="radio" class="mr-2" data-id="{{ $compra->id }}" data-rifa="{{ $product->id }}" id="popular-{{ $compra->id }}" onchange="changePopular(this)" name="popular" {{ $compra->popular ? 'checked' : '' }}>
