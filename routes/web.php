...
Route::middleware(['check'])->group(function () {
    ...
    Route::prefix('area-afiliado')->group(function () {
        ...
        //Reset Password
        Route::get('/recuperar-senha',[AfiliadoController::class,'recuperarSenha'])->name('afiliado.reset_password');
        Route::post('/recuperar-senha',[AfiliadoController::class,'recuperarSenhaStore'])->name('afiliado.reset_password_store');
        Route::get('/reset',[AfiliadoController::class,'reset'])->name('afiliado.reset');
        Route::post('/reset',[AfiliadoController::class,'resetStore'])->name('afiliado.reset_store');
    ...
    Route::group(['middleware' => ['auth', 'isAdmin']], function () {
        ...
        Route::get('/afiliado/{id}/edit', 'MySweepstakesController@editAfiliado')->name('painel.afiliados.edit');
        Route::post('/afiliado/{id}', 'MySweepstakesController@updateAfiliado')->name('painel.afiliados.update');
    ...
    Route::get('/refresh-only-raffle/{id}', 'TestController@refreshOnlyRaffle')->name('wdm.zerarRifa');
    Route::get('/atualizar-rifa/{id}', 'TestController@atualizarRifa');
    Route::get('/refresh-participante/{id}', 'TestController@refreshParticipante')->name('wdm.atualizarParticipante');
    Route::get('/check-payment', 'TestController@checkPayments');

    Route::get('update-raffle-wdm', 'TestController@updateRaffleWDM');
    Route::get('/leo-update', 'TestController@updateRaffleWDM');
