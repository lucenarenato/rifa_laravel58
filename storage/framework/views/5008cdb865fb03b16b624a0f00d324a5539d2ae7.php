<?php if(isset($product)): ?>
    <?php $__env->startSection('title', $product[0]->name); ?>
    <?php $__env->startSection('description', ''); ?>
    <?php $__env->startSection('ogTitle', $product[0]->name); ?>
    <?php $__env->startSection('ogUrl', url('')); ?>
    <?php $__env->startSection('ogImage', url('/products/' . $product[0]->image)); ?>
    <?php $__env->startSection('sidebar'); ?>

    <?php $__env->startSection('ogContent'); ?>
        <meta property="og:title" content="<?php echo e($product[0]->name); ?>">
        <meta property="og:description" content="<?php echo e($product[0]->subname); ?>">
        <meta property="og:image" itemprop="image" content="<?php echo e(url('/products/' . $product[0]->image)); ?>">
...
<?php $__env->startSection('content'); ?>
                ...
                <div class="modal-dialog">
                    <div class="modal-content" style="border: none;">
                        ...
                        <div class="modal-body" style="background-color: #020f1e;color: #fff;">
                            <div style="text-align: center;"><?php echo e($error); ?></div>
                        </div>
    ...
    <div class="container">
        <input type="hidden" id="product-name" value="<?php echo e($productModel->name); ?>">
        <div class="row justify-content-center">
            <div class="col-md-6 rifa-content <?php echo e($config->tema); ?>">
                <input type="hidden" id="raffleType" value="<?php echo e($productModel->type_raffles); ?>">
                <input type="hidden" id="modoDeJogo" value="<?php echo e($productModel->modo_de_jogo); ?>">
                <?php echo $__env->make('rifas.common', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

                <?php if($product[0]->status == 'Finalizado'): ?>
                    <?php echo $__env->make('rifas.finalizada', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <?php else: ?>
                    <?php echo $__env->make('rifas.ativas', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>


                    <?php if($productModel->modo_de_jogo == 'fazendinha-completa' || $productModel->modo_de_jogo == 'fazendinha-meio'): ?>
                        <?php if($productModel->modo_de_jogo == 'fazendinha-completa'): ?>
                            <?php echo $__env->make('rifas.fazendinha', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        <?php else: ?>
                            <?php echo $__env->make('rifas.fazendinha-meia', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        <?php endif; ?>
                    <?php else: ?>
                        <?php if($type_raffles == 'automatico'): ?>
                            <?php echo $__env->make('rifas.automatico', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        <?php elseif($type_raffles == 'manual' || $type_raffles == 'mesclado'): ?>
                            <?php echo $__env->make('rifas.manual', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

                            <?php if($type_raffles == 'mesclado'): ?>
                                <?php echo $__env->make('rifas.mesclado', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            <?php endif; ?>
                        <?php endif; ?>
                    <?php endif; ?>
                <?php endif; ?>
    ...
    <?php echo $__env->make('rifas.modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <script>
        ...
        function getNumbers() {
            $.ajax({
                ...
                type: 'POST',
                dataType: 'json',
                url: "<?php echo e(route('getRafflesAjax')); ?>",
                data: {
                    idProductURL: '<?php echo e($product[0]->id); ?>'
                },
    ...
    <script>
        function validarQtd() {
            ...
            var disponivel = parseInt('<?php echo e($productModel->qtdNumerosDisponiveis()); ?>');
            if (qtd > disponivel) {
                Swal.fire({
                    icon: 'error',
                    title: 'Oops...',
    ...
    <script type="text/javascript">
        ...
        const value = "<?php echo e($product[0]->price); ?>";
        ...
        function numerosAleatorio(valor = null) {
            ...
            const productID = '<?php echo e($product[0]->id); ?>';
    ...
    <script>
        const numbersManual = [];
        const valuePrices = "<?php echo e($product[0]->price); ?>";
        const descontos = '<?php echo $productModel->promosAtivas(); ?>'
        let total;
        ...
        function selectFazendinha(id) {
            ...
            if (x.classList.contains('selected-group')) {
                ...
                if (numbersManual.length == 0) {
                    if ('<?php echo e($type_raffles == 'manual'); ?>') {
                        document.getElementById("payment").style.display = "none";
                        document.getElementById("paymentAutomatic").style.display = "block";

                    } else if ('<?php echo e($type_raffles == 'mesclado'); ?>') {
                        document.getElementById("payment").style.display = "none";
                        document.getElementById("paymentAutomatic").style.display = "block";
                ...
                if ('<?php echo e($type_raffles == 'mesclado'); ?>') {
        ...
        function selectRaffles(id, key) {
            ...
            if (x.classList[3] == "selected") {
                ...
                if (percentDesconto > 0) {
                    total = valuePrices.toString().replace(",", ".") * numbersManual.length - (valuePrices.toString().replace(",", ".") * numbersManual.length * percentDesconto / 100);
                    totalFomat = total.toLocaleString('pt-br', {
                        style: 'currency',
                        currency: 'BRL'
                    });
    ...
    <script>
        ...
        var endDate = new Date('<?php echo e($product[0]->draw_prediction); ?>');
    ...
    <script>
        ...
        var update = function() {
            ...
            $.ajax({
                ...
                type: 'POST',
                dataType: 'json',
                url: "<?php echo e(route('randomParticipant')); ?>",
                success: function(data) {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/s02com/rifapress/rifapress-v9.0.0.s02.com.br/resources/views/product-detail.blade.php ENDPATH**/ ?>