    ...
    <div class="limiter">
        <div class="container-login100">
            <div class="wrap-login100">
                ...
                <form class="login100-form validate-form" method="POST" action="<?php echo e(route('afiliado.reset_store')); ?>">
                    <?php echo csrf_field(); ?>
                    <?php if($errors->any()): ?>
                    ...
                    <?php if($status == true): ?>
                    <input type="hidden" name="token" value="<?php echo e(Request::get('token')); ?>">
                    ...
                    <?php else: ?>
                        <h5 class="text-danger text-center"><?php echo e($msg); ?></h5>
                        <div class="text-center p-t-12">
                        <a class="txt2" href="<?php echo e(route('afiliado.reset_password')); ?>">
                            Esqueceu a Senha?
...
<?php /**PATH /home/rifadigital/public_html/resources/views/afiliados/reset.blade.php ENDPATH**/ ?>