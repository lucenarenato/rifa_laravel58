    ...
    <div class="limiter">
        <div class="container-login100">
            <div class="wrap-login100">
                ...
                <form class="login100-form validate-form" method="POST" action="<?php echo e(route('afiliado.login')); ?>">
                    <?php echo csrf_field(); ?>
                    <?php if($errors->any()): ?>
                    ...
                    <div class="text-center p-t-12">
                        <a class="txt2" href="<?php echo e(route('afiliado.cadastro')); ?>">
...
<?php /**PATH /home/rifadigital/public_html/resources/views/afiliados/login.blade.php ENDPATH**/ ?>