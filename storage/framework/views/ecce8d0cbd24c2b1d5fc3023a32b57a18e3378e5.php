                ...
                <section class="title-payment-container mt-2">
                    <section class="title-payment-content">
                        ...
                        <section class="title-payment-texts mt-3 ml-3">
                            <h2 class="title-payment-text <?php echo e($config->tema); ?>" id="payment-text">Aguardando Pagamento!</h2>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/s02com/rifapress/rifapress-v9.0.0.s02.com.br/resources/views/new-checkout.blade.php ENDPATH**/ ?>