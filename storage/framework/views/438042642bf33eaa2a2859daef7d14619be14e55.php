                        ...
                        <table class="table table-striped table-bordered table-responsive-sm table-hover align=center"
                            ...
                            <tbody>
                                <?php $__currentLoopData = $afiliados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $afiliado): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($afiliado->name); ?></td>
                                        <td><?php echo e(date('d/m/Y', strtotime($afiliado->created_at))); ?></td>
                                        <td>R$ <?php echo e(number_format($afiliado->totalGanhos(), 2, ",", ".")); ?></td>
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item" href="<?php echo e(route('painel.afiliados.edit', $afiliado->id)); ?>">
                                                        <i class="bi bi-pen"></i>&nbsp; Editar
                                                    </a>
                                                    <a class="dropdown-item" href="<?php echo e(route('painel.excluirAfiliado', $afiliado->id)); ?>"><i class="bi bi-trash3"></i>&nbsp;Excluir</a>
                                                </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rifadigital/public_html/resources/views/listaAfiliados.blade.php ENDPATH**/ ?>