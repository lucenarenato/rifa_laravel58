...
<div class="modal fade" id="modal_criar_compra" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <form action="<?php echo e(route('compras.criar')); ?>" method="POST">
        <?php echo csrf_field(); ?>
                ...
                <div class="modal-body">
                    ...
                    <div class="row" style="font-size: 12px;">
                        ...
                        <div class="col-md-4 mt-2">
                            ...
                            <input type="number" id="qtdNumeros" name="qtdNumeros" class="form-control" max="<?php echo e($rifa->qtdNumerosDisponiveis()); ?>" min="<?php echo e($rifa->minimo); ?>" value="<?php echo e($rifa->minimo); ?>" required>
                        </div>
...
<script>
    ...
    function aleatorio(idRifa) {
        ...
        $.ajax({
            url: "<?php echo e(route('compras.randomNumbers')); ?>",
            type: 'POST',
            dataType: 'json',
            data: {
                "id": idRifa,
...
<?php /**PATH /home/s02com/rifapress/rifapress-v9.0.0.s02.com.br/resources/views/compras/modal/criarCompra.blade.php ENDPATH**/ ?>