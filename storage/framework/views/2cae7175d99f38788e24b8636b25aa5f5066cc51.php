...
<div class="container" id="rafflesSection" style="margin-top: 10px;text-align: center">
    <h6 style=" color: #ffffff;font-weight: bold; font-size: 12px;"><i class="bi bi-award"></i> Escolha você mesmo
        clicando no(s)
...
<input type="number" style="text-align: center;background-color: #E5E5E5;color: #000000;font-weight: bold; display:none"
    id="numbersA" value="<?php echo e($productModel->minimo); ?>" min="<?php echo e($productModel->minimo); ?>" max="<?php echo e($productModel->maximo); ?>"
...
<?php if(env('APP_URL') == 'rifasonline.link'): ?>
    <div class="d-flex justify-content-between font-weight-600 mb-2" style="font-size: 12px;">
        <div class="col-md-4 p-1 text-center disponivel-rm">
            COTAS <br> DISPONÍVEIS (<?php echo e($productModel->qtdNumerosDisponiveis()); ?>)
        </div>
        <div class="col-md-4 p-1 text-center reservadas-rm">
            COTAS <br> RESERVADAS (<?php echo e($productModel->qtdNumerosReservados()); ?>)
        </div>
        <div class="col-md-4 p-1 text-center pagas-rm">
            COTAS <br> PAGAS (<?php echo e($productModel->qtdNumerosPagos()); ?>)
        </div>
    </div>
<?php else: ?>
    <div class="d-flex justify-content-between font-weight-600 mb-2">
        <div class="seletor-item rounded d-flex justify-content-between box-shadow-08 font-xs" style="cursor: pointer;"
            ...
            <div class="num bg-cota text-white p-2 rounded-end">
                <?php echo e($productModel->qtdNumerosDisponiveis()); ?>
        ...
        <div class="seletor-item rounded d-flex justify-content-between box-shadow-08 font-xs" style="cursor: pointer;"
            ...
            <div class="num bg-info text-white p-2 rounded-end">
                <?php echo e($productModel->qtdNumerosReservados()); ?>
        ...
        <div class="seletor-item rounded d-flex justify-content-between box-shadow-08 font-xs" style="cursor: pointer;"
            ...
            <div class="num bg-success text-white p-2 rounded-end">
                <?php echo e($productModel->qtdNumerosPagos()); ?>
...
<div class="container text-center">
    <div class="raffles <?php echo e($product[0]->status == 'Finalizado' ? 'finished' : ''); ?>" id="raffles">
        <div id="message-raffles" class="blob" style="background: green; color: #fff">
        </div>
    </div>
</div>
...
<?php /**PATH /home/s02com/rifapress/rifapress-v9.0.0.s02.com.br/resources/views/rifas/manual.blade.php ENDPATH**/ ?>