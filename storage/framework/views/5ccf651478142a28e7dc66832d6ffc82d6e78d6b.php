    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background: #010140">
            ...
            <a href="/" class="brand-link text-center"
                ...
                <span class="brand-text font-weight-light">Ver Site</span>
            </a>
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <?php endif; ?>
                                <li class="nav-item">
                                    <a href="<?php echo e(route('wpp.index')); ?>"
                                        class="nav-link <?php echo e(request()->is('wpp-mensagens*') ? 'active' : ''); ?>"
                                        id="wpp-msgs">
                                ...
                                <li class="nav-item">
                                    <a href="<?php echo e(route('tutoriais')); ?>"
                                        class="nav-link <?php echo e(request()->is('tutoriais*') ? 'active' : ''); ?>"
                                        id="wpp-msgs">
...
<?php /**PATH /home/s02com/rifapress/rifapress-v9.0.0.s02.com.br/resources/views/layouts/admin.blade.php ENDPATH**/ ?>