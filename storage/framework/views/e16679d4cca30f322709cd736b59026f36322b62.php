    ...
    <div class="modal-dialog">
        <div class="modal-content" style="border: none;">
            ...
            <div class="modal-body" style="background-color: #020f1e;">
                <div class="row">
                    <div class="col-md-12">
                        <form action="<?php echo e(route('consultingReservation')); ?>" method="POST" style="display: flex;">
                            <?php echo e(csrf_field()); ?>
        ...
        <div class="modal-content" style="border: none;">
            ...
            <div class="modal-body" style="">
                <div class="col-md-12 text-center">
                    Estes são os prêmios disponíveis no sorteio <strong><?php echo e($productModel->name); ?></strong>
                </div>
                <hr>
...
<?php /**PATH /home/s02com/rifapress/rifapress-v9.0.0.s02.com.br/resources/views/rifas/modal.blade.php ENDPATH**/ ?>