...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/vendor/glide.core.min.css')); ?>" />

    <link rel="stylesheet" href="<?php echo e(asset('css/vendor/introjs.min.css')); ?>" />
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/vendor/plyr.css')); ?>" />
...
<body>
        ...
        <div id="nav" class="nav-container d-flex">
            <div class="nav-content d-flex">
                        ...
                        <div class="row mb-1 ms-0 me-0">
                            ...
                            <div class="col-6 pe-1 ps-1">
                                <ul class="list-unstyled">
                                    <li>
                                        <a href="<?php echo e(route('afiliado.logout')); ?>">
                ...
                <ul class="list-unstyled list-inline text-center menu-icons">
                    ...
                    <li class="list-inline-item">
                        <a href="<?php echo e(route('afiliado.logout')); ?>" id="colorButton" title="Sair">
                            <i data-acorn-icon="logout" class="me-2" data-acorn-size="17"></i>
                        </a>
                    </li>
                </ul>
                ...
                <div class="menu-container flex-grow-1">
                    <ul id="menu" class="menu">
                        <li>
                            <a href="<?php echo e(route('afiliado.home')); ?>"
                                class="<?php echo e(request()->is('area-afiliado') ? 'active' : ''); ?>">
                        ...
                        <li>
                            <a href="<?php echo e(route('afiliado.rifas')); ?>"
                                class="<?php echo e(request()->is('area-afiliado/rifas-ativas') ? 'active' : ''); ?>">
                        ...
                        <li>
                            <a href="<?php echo e(route('afiliado.pagamentos')); ?>"
                                class="<?php echo e(request()->is('area-afiliado/pagamentos') ? 'active' : ''); ?>">
                        ...
                        <div class="page-title-container">
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-6">
                                    <h1 class="mb-0 pb-0 display-4" id="title"><?php echo $__env->yieldContent('title-page'); ?></h1>
                                </div>
                                <!-- Title End -->

                                <?php echo $__env->yieldContent('buttons-starts'); ?>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 col-sm-12 text-center">
                            <?php if(env('APP_NAME') == 'Laravel'): ?>
                                <p class="mb-0 text-muted text-medium">Desenvolvido por <a target="_blank" href="https://seuscript.com.br">SEU SCRIPT</a> | &copy; Copyright. Todos os direitos reservados.</p>
                            <?php else: ?>
    ...
    <script src="<?php echo e(asset('js/vendor/chartjs-plugin-rounded-bar.min.js')); ?>"></script>
    <script src="<?php echo e(asset('js/vendor/glide.min.js')); ?>"></script>
    <script src="<?php echo e(asset('js/vendor/intro.min.js')); ?>"></script>

    <script src="<?php echo e(asset('js/vendor/plyr.min.js')); ?>"></script>
    <script src="<?php echo e(asset('js/vendor/imask.js')); ?>"></script>
    <script src="<?php echo e(asset('js/vendor/jquery.validate/jquery.validate.min.js')); ?>"></script>

    <script src="<?php echo e(asset('js/common.js')); ?>"></script>
    <script src="<?php echo e(asset('js/scripts.js')); ?>"></script>
    <script src="<?php echo e(asset('js/vendor/bootstrap-notify.min.js')); ?>"></script>
    <script src="<?php echo e(asset('js/plugins/notifies.js')); ?>"></script>
    <script src="<?php echo e(asset('js/forms/inputmask.js')); ?>"></script>
...
<?php /**PATH /home/rifadigital/public_html/resources/views/afiliados/layout/menuAfiliados.blade.php ENDPATH**/ ?>