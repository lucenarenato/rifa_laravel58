        ...
        <div class="row justify-content-center">
            <div class="col-md-6 col-12 rifas <?php echo e($config->tema); ?>">
                ...
                <?php $__currentLoopData = $products->where('favoritar', '=', 0); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(route('product', ['slug' => $product->slug])); ?>" class="sorteio sorteio-<?php echo e(strtolower($product->status)); ?> <?php echo e($product->status == 'Finalizado' ? 'd-none' : ''); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Dener\Downloads\app_rifa\resources\views/sorteios.blade.php ENDPATH**/ ?>